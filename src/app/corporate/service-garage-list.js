...
import { requestCreate } from "../../redux/actions/corporate/providerAction";
import { garageSearch } from "../../redux/actions/corporate/searchAction";
...
const CorporateServiceGarageList = () => {
                                    ...
                                    garageSearchData.getProviders.map( (item, i) => 
                                        <div key={i} className="GaragesBox">
                                            <div className="GaragesHead">
                                                ...
                                                <figcaption>
                                                    <article>
                                                        ...
                                                        <aside>
                                                            <Link to="/corporate/service-garage/detail" className="views" target="_blank" onClick={() => handleDetail(item._id)}> View Profile  </Link>
                                            ...
                                            <div className="GaragesMiddle">
                                                ...
                                                <aside>
                                                    {  searchingStorage.corporateVehicleData ?  <p>Vehicle: <span> { searchingStorage.vehicleDetail[0].vehicleNumber } { searchingStorage.vehicleDetail[0].model } { searchingStorage.vehicleDetail[0].make } { searchingStorage.vehicleDetail[0].type } { searchingStorage.vehicleDetail[0].year } </span></p> : '' }
                                                </aside>
                                            </div> 
                                        </div>
                                    )
...
export default CorporateServiceGarageList