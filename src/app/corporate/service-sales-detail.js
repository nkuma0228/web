...
import { salesView } from "../../redux/actions/corporate/providerAction";
        ...
        <>
            ...
            <div className="WrapperArea">
                <div className="WrapperBox"> 
                    ...
                    <Link to="/corporate/service-auto-sales/list"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back</Link> <h4> { salesData.business } </h4>
                    </div>
                    <div className="DealerDetails">
                        ...
                        <div className="Small-Wrapper">
                            <div className="CommentBox">
                                <h2>
                                    Ratings & Reviews:
                                    <Link to="/corporate/service-auto-sales/review" onClick={handleReviewView} className="reviewButtonView">
