...
import { vehicleList } from "../../redux/actions/corporate/searchAction";
...
const CorporateServiceGarage = () => {
    ...
    const getListData = useSelector(state => state.corporatesearching)
    const { corporateVehicleData } = getListData
    useEffect(() => {
        const data = { keyword: '' }
    ...
    let handleSubmit = async (event) => {
        ...
        if (formIsValid) {
            ...
            let vehicleDetail = corporateVehicleData.filter(function (item) {
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" name="myVehicle" onChange={handleInputChange}>
                                                        ...
                                                        {
                                                            corporateVehicleData && corporateVehicleData.map((item) =>
...
export default CorporateServiceGarage