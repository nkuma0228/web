...
import { garageView } from "../../redux/actions/corporate/providerAction";

import Slider from "../../assets/client/images/Slider.png"
import Header from "./header";
import Footer from "./footer";

const CorporateServiceGarageDetail = () => {
        ...
        <>
            ...
            <div class="WrapperArea">
                <div class="WrapperBox"> 
                    <div class="TitleBox">
                        <Link to="/corporate/service-garage/list"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back</Link> <h4> { garageData.business } </h4>
                    </div>
                    <div class="DealerDetails">
                        ...
                        <div class="Small-Wrapper">
                            <div class="CommentBox">
                                <h2>
                                    Ratings & Reviews:
                                    <Link to="/corporate/service-garage/review" onClick={handleReviewView} class="reviewButtonView">
...
export default CorporateServiceGarageDetail