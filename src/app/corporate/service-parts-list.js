...
import { requestDealerCreate } from "../../redux/actions/corporate/providerAction";
import { dealerSearch } from "../../redux/actions/corporate/searchAction";
...
const CorporateServicePartsList = () => {
                                            ...
                                            <div className="GaragesHead">
                                                ...
                                                <figcaption>
                                                    <article>
                                                        ...
                                                        <aside>
                                                            <Link to="/corporate/service-parts/detail" className="views" onClick={() => handleDetail(item._id)}> View Profile  </Link>
...
export default CorporateServicePartsList