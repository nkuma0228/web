...
import { 
    ...
    submitSalesReject, 
    salesQuoteAccept,
    } from "../../redux/actions/corporate/providerAction";
...
const CorporateDashboard = () => {
    ...
    const { requestGarageListingData, requestPartListingData, requestSalesListingData } = getListData
                                ...
                                requestGarageListingData && requestGarageListingData.length>0 ? requestGarageListingData.map((item, i) =>
                                    <div className="GaragesBox" key={i}>
                                        ...
                                        <div className="GaragesMiddle">
                                            ...
                                            <aside>
                                                <p>Vehicle: <span> {item.corporateVehicleData.vehicleNumber?item.corporateVehicleData.vehicleNumber+',':'' } {item.corporateVehicleData.model?item.corporateVehicleData.model+',':'' }  {item.corporateVehicleData.make?item.corporateVehicleData.make+',':''} {item.corporateVehicleData.year?item.corporateVehicleData.year+'':''} {item.corporateVehicleData.type?item.corporateVehicleData.type+'':''} </span></p>
            ...
            <Modal show={welcomeModalShow} className="PanelModal">
                <div className="modal-body">
                    <div className="CongratulationsBox Welcome">
                        ...
                        <ul>
                            <li><Link to="/corporate/service-garage">Services Garage</Link></li>
                            <li><Link to="/corporate/service-parts">{ t('client.dashboard.ServicesAutoParts') }</Link></li>
                            <li><Link to="/corporate/service-auto-sales">{ t('client.dashboard.ServicesAutoSales') }</Link></li>
                        </ul>
                    </div>
                </div>
            </Modal>
