...
import { requestFutureCalendarDetail } from "../../redux/actions/provider/dealerAction";

const format = 'h:mm a';
const now = moment().hour(0).minute(0);

const DealerFutureAppointmentCalendarDetail = () => {
...
export default DealerFutureAppointmentCalendarDetail