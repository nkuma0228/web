...
import { futureAppointmentList } from "../../redux/actions/provider/dealerAction";

const DealerFutureAppointmentCalendar = () => {
    ...
    const handleDetail = (id) => {
        ...
        navigate("/dealer/future_appointment_calendar/details")
    }
    ...
    const renderEventContent = (eventInfo) => {
        return (
          ...
          <div className='VehicleEvent'>
                ...
                <Link className="Blue" to="/dealer/future_appointment_calendar/details" onClick={()=>handleDetail(eventInfo.event.extendedProps.service_id)}>
                    view Details
                </Link>
            </div>
          </>
...
export default DealerFutureAppointmentCalendar