...
import Logo from "../../assets/dealer/images/Logo.png"
import Profile from "../../assets/dealer/images/profile.png"
import Nav1 from "../../assets/dealer/images/Nav-1.svg"
import Nav2 from "../../assets/dealer/images/Nav-2.svg"
import Nav3 from "../../assets/dealer/images/Nav-3.svg"
import Nav4 from "../../assets/dealer/images/Nav-4.svg"
import Nav5 from "../../assets/dealer/images/Nav-5.svg"
import Nav6 from "../../assets/dealer/images/Nav-6.svg"
                ...
                <ul>
                    <li>
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item href="#/dealer/dashboard/client"> { t('vendor.sidemenu.Client') }  </Dropdown.Item>
                                <Dropdown.Item href="#/dealer/history"> { t('garage.sidemenu.History') }   </Dropdown.Item>
                                <Dropdown.Item href="#/dealer/dashboard/garages"> { t('vendor.sidemenu.Garage') } </Dropdown.Item>
                                <Dropdown.Item href="#/dealer/dashboard/corporate"> { t('vendor.sidemenu.Corporate') } </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </li>
                    ...
                    <li>
                        <Dropdown>
                            <Dropdown.Toggle id="dropdown-basic"> <span><img src={Nav2} /></span> { t('vendor.sidemenu.MyOrder') } </Dropdown.Toggle>
                            <Dropdown.Menu>
                                <Dropdown.Item href="#/dealer/mycalendar/client"> { t('vendor.sidemenu.Client') } </Dropdown.Item>
                                <Dropdown.Item href="#/dealer/mycalendar/garages"> { t('vendor.sidemenu.Garage') } </Dropdown.Item>
                                <Dropdown.Item href="#/dealer/mycalendar/corporate"> { t('vendor.sidemenu.Corporate') } </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </li>

                    <li>
                        <Link to="/dealer/my_parts">
                            <span><img src={Nav6} /></span> { t('vendor.sidemenu.MyParts') } 
                        </Link>
                    </li>

                    <li>
                        <Link to="/dealer/account">
                            <span><img src={Nav4} /></span> { t('vendor.sidemenu.AccountSettings') } 
                        </Link>
                    </li>
                    <li>
                        <Link to="" onClick={handleLogout}>
                            <span><img src={Nav9} /></span> { t('vendor.sidemenu.Logout') } 
                        </Link>
                    </li>
                </ul>
            </div>
