...
import { requestHistory, territoryListing, requestFutureAppointment } from "../../redux/actions/provider/dealerAction";
...
const DealerHistory = () => {
    ...
    const { requestDataHistory, territoryData } = getListData
    console.log("requestDataHistory",requestDataHistory)
    ...
    useEffect(() => {
        ...
        const data = { pageNumber:1, territory:territory, startDate:'', endDate:'', keyword:''}
    ...
    const handlePageChange = (pageNumber) => {
        ...
        dispatch(requestHistory({ pageNumber:pageNumber, territory:territory, startDate:'', endDate:'', keyword:''}));
    };
    ...
    let handleSubmitFilter = (event) => {
        ...
        if (keyword || territory || startDate || endDate) {
            const data = { pageNumber:1, territory, startDate, endDate, keyword }
            dispatch(requestHistory(data))
        } else {
    ...
    const handleDetail = (id) => {
        ...
        navigate("/dealer/history/details")
    }
                                        ...
                                        <tr key={i}>
                                            ...
                                            <td>
                                                <div className="Actions"> 
                                                    <Link className="Blue" to="/dealer/history/details" onClick={()=>handleDetail(item._id)}>
