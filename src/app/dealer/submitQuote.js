...
const SubmitQuote = () => {
    ...
    const getPartsIndexWise = JSON.parse(window.localStorage.getItem('partsIndexWise'));

    const [quoteDetails, setQuoteDetails] = useState({})
    const [partsIndexWise, setPartsIndexWise] = useState(getPartsIndexWise)
    
    useEffect(() => {
        const getQuoteDetails = JSON.parse(window.localStorage.getItem('quoteDetails'));
