...
import { dealerReviews, dealerReplyCreate } from "../../redux/actions/provider/authAction";
...
const MyDealerReviews = () => {
    ...
    let handleReplySubmit = (event) => {
      ...
      if (formIsValid) {
          ...
          dispatch(dealerReplyCreate(data)).then(res => {
              if (res.code == 200) {
            ...
            <div class="WrapperArea">
                <div class="WrapperBox"> 
                    ...
                    <div class="Small-Wrapper">
                        <div class="TitleBox">
                            <h4>Part Dealer Ratings & Reviews</h4>
                        </div>
...
export default MyDealerReviews