        ...
        <>
            ...
            <section>
                <div class="BannerArea">
                    <h3>{ t('website.serviceautosales.AutoSales') }</h3>
                    <ul>
                        <li><Link to="/">{ t('website.serviceautosales.Home') }</Link></li>
                        <li class="active"><a href="javascript:void(0);">{ t('website.serviceautosales.AutoSales') }</a></li>
                    </ul>
                </div>
            </section>
                                ...
                                <div class="VideoBox">
                                    ...
                                    <div class="VideoBody">
                                        ...
                                        <ul>
                                        {
                                            ...
                                            :
                                                <>
                                                    <li><Link to="/service-provider-signup/sales">{ t('website.serviceautoparts.Registertocontinue') }</Link></li>
...
export default ServiceAutoSales