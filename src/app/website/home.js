        ...
        <>
            ...
            <div className="SliderArea">
                ...
                <div className="SlideContent">
                    ...
                    <ul>
                        <li><Link to="/auto-repair">{ t('website.home.AutoRepair') }</Link></li>
                        <li><Link to="/auto-parts">{ t('website.home.AutoParts') }</Link></li>
                        <li><Link to="/auto-sales">{ t('website.home.AutoSales') }</Link></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                                    ...
                                    <figcaption>
                                        ...
                                        <article>    
                                        {
                                            headerLogin && (Object.getOwnPropertyNames(headerLogin).length != 0)?
                                                ...
                                                <Link to="/service-auto-repair"> { t('website.home.Moreinfo') } </Link>
                                            :
                                                <>
                                                    <Link to="/service-auto-repair">{ t('website.home.Moreinfo') }</Link>
                                                    <Link to="" onClick={handleShow}>{ t('website.home.Login') }</Link>
                                                </>
                                        }
                                        </article>
                                    </figcaption>
                                    ...
                                    <figcaption>
                                        ...
                                        <article>
                                        {
                                            headerLogin && (Object.getOwnPropertyNames(headerLogin).length != 0)?
                                                ...
                                                <Link to="/service-auto-parts">{ t('website.home.Moreinfo') }</Link>
                                            :
                                                <>
                                                    <Link to="/service-auto-parts">{ t('website.home.Moreinfo') }</Link>
                                                    <Link to="" onClick={handleShow}>{ t('website.home.Login') }</Link>
                            ...
                            <div className="col-sm-4">
                                <div className="ServiceBox">
                                    <figure>
                                        <img alt="" src={Service3} style={{ width: "329px", height: "217px" }}/>
                                    </figure> 
                                    <figcaption>
                                        ...
                                        <article>
                                        {
                                            headerLogin && (Object.getOwnPropertyNames(headerLogin).length != 0)?
                                                ...
                                                <Link to="/service-auto-sales">{ t('website.home.Moreinfo') }</Link>
                                            :
                                                <>
                                                    <Link to="/service-auto-sales">{ t('website.home.Moreinfo') }</Link>
                                                    <Link to="" onClick={handleShow}>{ t('website.home.Login') }</Link>
