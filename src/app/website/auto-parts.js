        ...
        <>
            ...
            <section>
                <div class="BannerArea">
                    <h3> { t('website.autoparts.AutoParts') } </h3>
                    <ul>
                        <li><Link to="/"> { t('website.autoparts.Home') } </Link></li>
                        <li class="active"><a href="javascript:void(0);"> { t('website.autoparts.AutoParts') } </a></li>
                    </ul>
                </div>
            </section>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="BenefitsLeft">
                                    <h3> { t('website.autoparts.YourCarisanimportantInvestment') } </h3>
                                    <h4> { t('website.autoparts.Benefitsforyou') } </h4>
                                    <p> { t('website.autoparts.Neverhavetroubletrackingdown') } </p>

                                    <p> { t('website.autoparts.Makeyourlifeeasierdealing') } </p>

                                    <p> { t('website.autoparts.TryAutowizforfree') } </p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-10 offset-sm-1">
                                <div class="VideoBox">
                                    ...
                                    <div class="VideoBody">
                                        <h3> { t('website.autoparts.Viewthevideoabove') } </h3>
                                        <p> { t('website.autoparts.TojointheAutowizfamily') } </p>
                                        ...
                                        <ul>
                                        {
                                            ...
                                            :
                                                <>
                                                    <li><Link to="/signup"> { t('website.autoparts.SignUpNow') } </Link></li>
                                                    <li><Link to="" onClick={handleShow}> { t('website.autoparts.ExistingClientLogin') } </Link></li>
                                                </>
                                        }
                                        </ul>
                                    </div>
