...
const MySales = () => {
    ...
    useEffect(() => {
        if (!_.isEmpty(providerData)) {
            ...
            updateData.salesVehicleType = providerData.salesVehicleType
            ...
            <div class="WrapperArea">
                <div class="WrapperBox"> 
                    ...
                    <div class="DealerDetails">
                                ...
                                <div class="GaragesHead"> 
                                    <figcaption>
                                        <article>
                                            ...
                                            <aside>
                                                <h6> { t('sales.MyGarage.Vehiclesservices') } :</h6>
                                                <p>
                                                {
                                                    salesVehicleType && salesVehicleType.length > 0 && salesVehicleType.map((item)=> (
                                                        (item.checked==true)?
                                                            item.name + ', '
                                                        :''
                                                    ))
                        ...
                        <div class="Small-Wrapper">
                            <div class="PartBox">
                                <h3> { t('sales.MyGarage.businessProvidedAutoSales') } :</h3> 
                                <ul>
                                    {
                                        businessType && businessType.length > 0 && businessType.map((item)=> (
                                            (item.checked==true)?
                                                <li> {item.name } </li>
                                            :''
                                        ))
                        ...
                        <div class="Small-Wrapper">
                            <div class="PaymentBox">
                                <h4> { t('sales.MyGarage.PaymentMethodAcceptedAutoSales') } :</h4>
                                <ul>
                                    {
                        ...
                        <div class="Small-Wrapper">
                            <div class="CommentBox">
                                <h2>
                                { t('sales.MyGarage.RatingsReviews') } 
                                    <Link to="/sales/my/reviews" onClick={handleReviewView} class="reviewButtonView">
                                        <span><i className="fa fa-star-o"></i></span>
                                        { t('sales.MyGarage.ViewReview') } 
                                    </Link>
                                </h2> 
                            </div>
                        </div>
