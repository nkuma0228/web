...
import { salesReviews, salesReplyCreate } from "../../redux/actions/provider/authAction";
...
const MySalesReviews = () => {
    ...
    let handleReplySubmit = (event) => {
      ...
      if (formIsValid) {
          ...
          dispatch(salesReplyCreate(data)).then(res => {
              if (res.code == 200) {
                ...
                <div className="WrapperBox"> 
                    ...
                    <div className="Small-Wrapper">
                        <div className="TitleBox">
                            <h4>Auto Dealer Ratings & Reviews</h4>
                        </div>
