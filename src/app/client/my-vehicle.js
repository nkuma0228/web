...
import { manufacturerList, modelList, vehicleList, vehicleCreate, vehicleView, vehicleUpdate, vehicleDelete } from "../../redux/actions/client/vehicleAction";
...
const MyVehicle = () => {
    ...
    const { manufacturerData, modelData, clientVehicleData, clientEditVehicleData } = getListData
    useEffect(() => {
        const data = {keyword:''}
    ...
    useEffect(() => {
        if (!_.isEmpty(clientEditVehicleData)) {

            const updateData = _.cloneDeep(veState)
            updateData.idEdit = clientEditVehicleData._id
            updateData.vehicleNumberEdit = clientEditVehicleData.vehicleNumber?clientEditVehicleData.vehicleNumber:''
            updateData.modelEdit = clientEditVehicleData.model
            updateData.makeEdit = clientEditVehicleData.make
            updateData.yearEdit = clientEditVehicleData.year
            updateData.typeEdit = clientEditVehicleData.type?clientEditVehicleData.type:''
            updateData.ownerEdit = clientEditVehicleData.owner?clientEditVehicleData.owner:''
    ...
    let handleVehicleSubmit = (event) => {
        ...
        if (formIsValid) {
            const data = { vehicleNumber, model, make, year, type, owner }
    ...
    const handleEditValidation = () => {
        ...
        console.log(vehicleNumberEditEmpty, modelEditEmpty, makeEditEmpty, yearEditEmpty, typeEditEmpty, ownerEditEmpty)
    ...
    let handleVehicleEditSubmit = (event) => {
        ...
        if (formIsValid) {
            const data = { id:idEdit, vehicleNumber:vehicleNumberEdit, model:modelEdit, make:makeEdit, year:yearEdit, type:typeEdit, owner:ownerEdit }
            console.log(data)
    ...
    const handleVehicleHistoryShow = (id) => { 
        ...
        navigate("/client/my-vehicle-history")
    }
                    ...
                    <div className="Small-Wrapper">
                        ...
                        <div className="TableList">
                            <table>
                                ...
                                <tbody>
                                {
                                    clientVehicleData && clientVehicleData.length>0 && clientVehicleData.map((item, i)=>
