...
import { salesMarkerList } from "../../redux/actions/client/searchAction";
          ...
          <GoogleMap
           ...
           }
           {
              ...
              (
                ...
                >
                <p><Link to="/client/service-auto-sales/detail" className="views markerlocation" target="_blank" onClick={() => handleDetail(selected.id)}>Business Name: {selected.business} <br/> Location: {selected.name}</Link></p>
                </InfoWindow>
              )
            }
       </GoogleMap>
