...
import { requestSalesCreate } from "../../redux/actions/client/providerAction";
import { salesSearch } from "../../redux/actions/client/searchAction";
...
const ServiceClientAutoSalesList = () => {
                                            ...
                                            <div className="GaragesHead">
                                                ...
                                                <figcaption>
                                                    <article>
                                                        ...
                                                        <aside>
                                                            <Link to="/client/service-auto-sales/detail" className="views" target="_blank" onClick={() => handleDetail(item._id)}> View Profile  </Link>
                                            ...
                                            <form onSubmit={handleSearchSubmit}>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label>Search by sales business name</label>
                                                        <input type="text" class="form-control" placeholder="Enter Sales business name" name="salesName" value={salesName} onChange={handleInputSearchChange}/>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
...
export default ServiceClientAutoSalesList