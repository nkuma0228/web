...
import { manufacturerList } from "../../redux/actions/client/vehicleAction";
...
const ServiceClientAutoSales = () => {
    ...
    let handleSubmit = async (event) => {   
        ...
        if (formIsValid) {
            ...
            navigate("/client/service-auto-sales/list")
        }
    }
...
export default ServiceClientAutoSales