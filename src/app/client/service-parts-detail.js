...
import { dealerView } from "../../redux/actions/client/providerAction";

import Slider from "../../assets/client/images/Slider.png"
import Header from "./header";
import Footer from "./footer";

const ServicePartsDetail = () => {
            ...
            <div className="WrapperArea">
                <div className="WrapperBox"> 
                    ...
                    <div className="TitleBox">
                        <Link to="/client/service-parts/list"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back</Link><h4> { dealerData.business } </h4>
                    </div>
                    ...
                    <div className="DealerDetails">
                        ...
                        <div className="Small-Wrapper">
                            <div className="CommentBox">
                                <h2>
                                    Ratings & Reviews:
                                    <Link to="/client/service-parts/review" onClick={handleReviewView} class="reviewButtonView">
...
export default ServicePartsDetail