...
import { requestCorporatePending, requestCorporateAvailable, requestCorporateRejected, requestCorporateAvailableStatus, requestAccepted, requestRejectedSataus } from "../../redux/actions/provider/garageAction";
...
const GarageDashboardCorporate = () => {
            ...
            <div className="WrapperArea">
                <div className="WrapperBox">
                    ...
                    <div className="TitleBox">
                        <h4>{ t('garage.sidemenu.DashboardCorproate') }</h4>
                    </div>
                                    ...
                                    <table>
                                        ...
                                        </tr>
                                        {
                                            requestDataPending && requestDataPending.length>0 ? requestDataPending.map((item , i) =>
                                                    ...
                                                    <tr key={i}>
                                                        <td> {i+1} </td>
                                                        <td> {item.corporateVehicleData.vehicleNumber } {item.corporateVehicleData.model }  {item.corporateVehicleData.make } {item.corporateVehicleData.year } {item.corporateVehicleData.type }</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <strong>Name : </strong> {item.corporateData.firstName } {item.corporateData.lastName }, <br /> 
                                                            <strong>Mobile : </strong> {item.corporateData.mobile }, <br /> 
                                                            <strong>Email : </strong> {item.corporateData.email }
                                                        </td>
                    ...
                    { (Object.keys(serviceDetailState).length > 0) ?
                        <>
                            ...
                            <div className="QuoteDetailsBox"> 
                                ...
                                <p><span>Name</span> { serviceDetailState.corporateData.firstName } { serviceDetailState.corporateData.lastName } </p>
                                <p><span>Contact Number</span> { serviceDetailState.corporateData.mobile } </p>  
                                <p><span>Email</span> { serviceDetailState.corporateData.email } </p>  
                            </div>
                            { 
...
export default GarageDashboardCorporate