...
import { requestCorporateQuotes, submitCorporateReject, corporateQuoteAccept, requestCorporateBookings } from "../../redux/actions/provider/garageAction";

import Header from "./header";
import Footer from "./footer";
import Sucessfull from "../../assets/client/images/sucessfull.png"

const GarageCorporatePortal = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { i18n, t } = useTranslation();
    
    const getListData = useSelector(state => state.garageRequestData)
    const { requestGarageCorporateListingData, requestGarageCorporateBookingListingData } = getListData
    ...
    const handlePartBookings = () => {
        ...
        dispatch(requestCorporateBookings(data))
    }
                ...
                <div className="WrapperArea">
                    <div className="WrapperBox"> 
                        ...
                        <div className="TitleBox">
                            <h4> { t('garage.corporate.corporateportal') } </h4>
                            <Link className="TitleLink" to="/garage/corporate-portal-request"> { t('garage.corporate.CreateCorporateOrder') } </Link>
                        </div> 

                        <div className="CommonTabs">
                            <ul className="nav nav-tabs">
                                <li className="nav-item" onClick={handlePartQuotes}>
                                    <a className="nav-link active" data-toggle="tab" href="#Quotes"> { t('garage.corporate.Corporatequotes') } </a>
                                </li>
                                <li className="nav-item" onClick={handlePartBookings}>
                                    <a className="nav-link" data-toggle="tab" href="#Bookings"> { t('garage.corporate.Corporatebookings') } </a>
                                </li> 
                            </ul>
                            ...
                            <div className="tab-content">
                                ...
                                {
                                    requestGarageCorporateListingData && requestGarageCorporateListingData.length>0 ? requestGarageCorporateListingData.map((item, i) =>
                                ...
                                {
                                    requestGarageCorporateBookingListingData && requestGarageCorporateBookingListingData.length>0 ? requestGarageCorporateBookingListingData.map((item, i) =>
...
export default GarageCorporatePortal