...
const GarageCorporatePortalRequest = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { i18n, t } = useTranslation();

    const getListData = useSelector(state => state.garageSearching)
    const { garageVehicleData, modelData } = getListData
    ...
    let handleSubmit = async (event) => {   
        ...
        if (formIsValid) {
            ...
            let vehicleDetail = garageVehicleData.filter(function (item) {
            ...
            navigate("/garage/corporate-portal-request/list")
        }
    }
                                    ...
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            ...
                                            <select className="form-control" name="myVehicle" onChange={handleInputChange}>
                                                ...
                                                {
                                                    garageVehicleData && garageVehicleData.map((item) =>
...
export default GarageCorporatePortalRequest