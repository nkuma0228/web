...
const GarageAccount = () => {
    ...
    useEffect(() => {
        ...
        if (!_.isEmpty(providerData)) {
            ...
            updateData.autoLocation = providerData.address
                ...
                <div className="WrapperBox"> 
                    ...
                    <div className="Small-Wrapper">
                        <div className="TitleBox">
                            <h4> { t('garage.account.AccountSettings') } </h4>
                        </div>
                        ...
                        <div className="StaticBoxArea">
                            ...
                            <div className="panel-group" id="accordion">
                                <div className="panel">
                                    <div className="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                                        <h4><span><i className="fa fa-user"></i></span> { t('garage.account.PersonalDetails') } </h4> 
                                    </div>
                                            ...
                                            <div className="ProfileBox">
                                                <div className="" style={{display: "flex", alignItems: "center", justifyContent: "space-between"}}>
                                                    <div className="EditNext">
                                                        <Link to="/garage/account/details" onClick={()=>handleGarageDetails(providerData)} className="Edit">
                                                            Edit Garage Services<i className="fa fa-long-arrow-right" aria-hidden="true"></i>
                                                        </Link>
                                                    </div> 
                                                </div>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-12">
                                                            <div className="text-center">
                                                                <button type="submit" className="Accept"> { t('garage.account.Update') } </button>
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </FORM>
                                ...
                                <div className="panel">
                                    <div className="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse3">
                                        <h4><span><i className="fa fa-picture-o" aria-hidden="true"></i></span> { t('garage.account.Gallery') } </h4> 
                                    </div>
                                        ...
                                        <div className="panel-body">
                                            <div className="CommonForm">
                                                <div className="col-sm-12">
                                                    ...
                                                    <div className="text-center">
                                                        <button type="button" className="Accept" onClick={uploadGalleryImages}>{ t('garage.account.Update') }</button>
                                                    </div>
                                                </div> 
                                            </div>
                                        </div>
                                ...
                                <div className="panel">
                                    <div className="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse333">
                                        <h4><span><i className="fa fa-money" aria-hidden="true"></i></span> { t('garage.account.PaymentMethod') } </h4> 
                                    </div>
                                    <div id="collapse333" className="panel-collapse collapse">
                                        <div className="panel-body">
                                            <h4 style={{ "marginBottom":"20px"}}> { t('garage.account.Paymentmethodaccepted') } :</h4>
                                ...
                                <div className="panel">
                                    <div className="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapse4">
                                        <h4><span><i className="fa fa-unlock-alt" aria-hidden="true"></i></span> { t('garage.account.Password') } </h4> 
                                    </div>
                                            ...
                                            <div className="CommonForm">
                                                <FORM onSubmit={handlePasswordSubmit}>
                                                    <div className="form-group">
                                                        <div className="row">
                                                            <div className="col-sm-3">
                                                                <label> { t('garage.account.EnteryouroldPassword') } </label>
                                                            </div>
                                                            <div className="col-sm-9">
                                                                <input type="password" className="form-control" name="oldPassword" placeholder={ t('garage.account.EnteryouroldPassword') } value={oldPassword} onChange={handleInputPasswordChange}/>
                                                    ...
                                                    <div className="form-group">
                                                        <div className="row">
                                                            <div className="col-sm-3">
                                                                <label> { t('garage.account.Createnewpassword') } </label>
                                                            </div>
                                                            <div className="col-sm-9">
                                                                <input type="password" className="form-control" name="password" placeholder={ t('garage.account.Createnewpassword') } value={password} onChange={handleInputPasswordChange} />
                                                    ...
                                                    <div className="form-group">
                                                        <div className="row">
                                                            <div className="col-sm-3">
                                                                <label> { t('garage.account.Confirmnewpassword') }</label>
                                                            </div>
                                                            <div className="col-sm-9">
                                                                <input type="password" className="form-control" name="confirmPassword" placeholder={ t('garage.account.Confirmnewpassword') } value={confirmPassword} onChange={handleInputPasswordChange} />
                                                                <span style={{ color: "red" }}>{confirmPasswordEmpty}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="text-center">
                                                        <button type="submit" className="Accept"> { t('garage.account.Updatepassword') } </button>
                                                    </div>
                                                </FORM>
                                            </div>
                                        </div>
                            ...
                            <div className="PannelTwo">
                                <Link to="/garage/my/reviews" onClick={handleReviewView}>
                                    <span><i className="fa fa-star-o"></i></span>
                                    { t('garage.account.Review') }
                                </Link>
                            </div>
